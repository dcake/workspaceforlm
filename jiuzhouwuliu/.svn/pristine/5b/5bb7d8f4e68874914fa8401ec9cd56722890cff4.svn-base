...
public abstract class BaseEntity<T> implements Serializable {
	 ...
	 * 当前App用户
	 */
	protected Users currentAppUser;
	...
	@JsonIgnore
	@XmlTransient
	public Users getCurrentAppUser() {
		if(currentAppUser == null){
			currentAppUser = AppUserUtils.getUser(false);
		}
	...
	public void setCurrentAppUser(Users currentAppUser) {
