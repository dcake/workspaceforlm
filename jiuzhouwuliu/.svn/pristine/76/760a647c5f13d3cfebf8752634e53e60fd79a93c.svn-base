...
<script type="text/javascript">
	...
	function doSubmit() {
		...
		var form = $('#infoForm');
		var options = {
			url : '${ctx}/agents/agents/saveDriver',
			type : 'post',
			data : {},
		...
		<form id="infoForm" method='post' class="breadcrumb form-search" style="background-color: white;" enctype="multipart/form-data">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="home">
					<ul class="ul-form" style="height:350px;">
						<!-------------------------------------基本信息--------------------------------------------------------------  -->
						<li><label>昵称：</label> <input type="text" id="username" name="username" maxlength="50" class="input-medium" style="width:163px" /> <span
							class="help-inline"><font color="red">*</font> </span></li>
						<li><label>姓名：</label> <input type="text" id="truename" name="truename" maxlength="50" class="input-medium" style="width:163px" /> <span
							class="help-inline"><font color="red">*</font> </span></li>
						...
						<li class="clearfix"></li>
						<li><label>手机：</label> <input type="text" id="phoneno" name="phoneno" maxlength="20" class="input-medium" style="width:163px"
							onkeyup="keyupInput(this);" /> <span class="help-inline"><font color="red">*</font> </span></li>
						<li><label>身份证号：</label> <input type="text" id="cardno" name="cardno" maxlength="50" class="input-medium" style="width:163px" /> <span
							class="help-inline"><font color="red">*</font> </span></li>
						<li class="clearfix"></li>
						<li><label>状态：</label> <select id="status" name="status" class="input-medium" style="width: 177px;">
								<option value="0" <c:if test="${agents.status=='0'}">selected</c:if>>正常</option>
								<option value="1" <c:if test="${agents.status=='1'}">selected</c:if>>锁定</option>
						...
						<li><label>支付积分：</label> <input type="text" id="currentPoint" name="currentPoint" maxlength="10" class="input-medium"
							onkeyup="keyupInput(this);" value="0" /></li>
						<li><label style="margin-right: 400px;margin-top: 35px;">头像：</label>
							<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 140px;margin-top: -50px;">
								<img id="headImg" class="imgClass" src="${users.headImg}" />
					...
					<!-- 身份证图片 -->
					<input id="upImage1" type="file" name="cardFaceImg_file" style="display:none" />
					<input id="upImage2" type="file" name="cardOtherImg_file" style="display:none" />
					<!-- 营业执照 -->
					<input id="upImage3" type="file" name="businessLicenseFaceImg_file" style="display:none" />
					<input id="upImage4" type="file" name="businessLicenseOtherImg_file" style="display:none" />
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div style="overflow:-Scroll;overflow-y:hidden;height: 500px;">
						...
						<ul class="ul-form" style="height:600px;">
							...
							<!-- 添加公司资质图片 -->
							<li id="imagesCompany" style="margin-top: 155px;"><label style="text-align: left;	width: 100%;padding-left: 50px">公司资质：</label>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 85px;margin-top: -1px;">
									<img id="businessLicenseFaceImg" class="imgClass" src="${agents.businessLicenseFaceImg}" />
									<div style="width: 124px;height: 43px;margin-top: -130px;">
										<input class="btn btn-primary" type="button" style="margin-left: 0px;margin-top: 138px;" value="营业执照正面" onclick="addImg3();" />
									</div>
								</div>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 215px;margin-top: -122px;">
									<img id="businessLicenseOtherImg" class="imgClass" src="${agents.businessLicenseOtherImg}" />
									<div style="width: 124px;height: 43px;margin-top: -130px;">
										<input class="btn btn-primary" type="button" style="margin-left: 0px;margin-top: 138px;" value="营业执照反面" onclick="addImg4();" />
									</div>
								</div>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 346px;margin-top: -122px;">
									<img src="<%=basePath%>static/images/5.jpg" class="imgClass" />
								</div>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 477px;margin-top: -122px;">
									<img src="<%=basePath%>static/images/5.jpg" class="imgClass" />
								</div></li>
