...
public class SystemService extends BaseService implements InitializingBean {
	 ...
	 * @return
	 */
	public User getUserByLoginName(String loginName,boolean isNewLoad) {
		User user= UserUtils.getByLoginName(loginName,isNewLoad);
		return user;
	}
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 * @description	：锁定用户
	 * @author pangchengxiang
	 * @date 2017年9月2日 上午11:23:19
	 * @return void
	 */
	@Transactional(readOnly = false)
	public void lockLogin(User user) {
