	 ...
	 <!-------------------------------------基本信息--------------------------------------------------------------  -->
	  	<ul class="ul-form" style="height:300px;">
	    	...
	    	<input type="text" class="input-medium" style="width:163px" value="${users.username}" readonly="readonly"/>
	    		...
	    		<li>
	    	<label>手机：</label>
	    	<input type="text" style="width:163px"  onkeyup="keyupInput(this);"value="${users.phoneno}" readonly="readonly"/>
		   	</li>
	    	...
	    	<li class="clearfix"></li>
	 		...
	 		<li>
		    	<label>支付积分：</label>
		    	<input type="text" class="input-medium"   onkeyup="keyupInput(this);"value="${users.currentPoint}" readonly="readonly"/>
		   	</li>
		   	<li class="clearfix"></li>
	    	<li>
		...
		<div role="tabpanel" class="tab-pane" id="profile">
			<div style="margin-top:50px;margin-top: -33px;" >
				<div style="overflow:-Scroll;overflow-y:hidden;height: 380px;">
					<input type="text" id="id" name="id" value="" style="display:none"/>
					<ul class="ul-form" style="height:380px;">
						<li style="list-style-type:none;">
							<label style="margin-left: -285px;margin-top: 50px;">企业名称：</label>
							<input type="text" class="input-medium" style="width:163px" value="${agents.companyName}" />
						</li>
						<!-- 添加身份证图片 -->
						<li class="clearfix"  style="list-style-type:none;"></li>
						  <li id="imagesCradNo" style="list-style-type:none;">
				    			<label style="margin-right: 479px;">身份证照片：</label>
						...
						<!-- 添加公司资质图片 -->
						  <li id="imagesCompany" style="list-style-type:none; margin-top: 15px;">
			    		         <label style="margin-right: 467px;">公司资质：</label>
						    		<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 85px;margin-top: -1px;">
							    			<img id="businessLicenseFaceImg"  style="width:120px;height:120px;cursor: pointer;" src="${agents.businessLicenseFaceImg}"/>
							    		</div>
							    			<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 215px;margin-top: -122px;">
							    			<img id="businessLicenseOtherImg"  style="width:120px;height:120px;cursor: pointer;" src="${agents.businessLicenseOtherImg}"/>
							    		</div>
	    	          </li>
					</ul>
				</div>
