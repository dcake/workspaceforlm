		...
		<form id="infoForm" method='post' class="breadcrumb form-search" style="background-color: white;" enctype="multipart/form-data">
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="home">
					...
					<!-------------------------------------基本信息--------------------------------------------------------------  -->
					<ul class="ul-form" style="height:323px;">
						<li><label>昵称：</label> <input type="text" id="username" name="username" maxlength="100" class="input-medium" style="width:163px"
							value="${users.username}" /> <span class="help-inline"><font color="red">*</font> </span></li>
						<li><label>姓名：</label> <input type="text" id="truename" name="truename" maxlength="100" class="input-medium" style="width:163px"
							value="${users.truename}" /> <span class="help-inline"><font color="red">*</font> </span></li>
						<li><label>密码：</label> <input type="password" id="password" name="password" maxlength="100" placeholder="若不修改密码，请留空" class="input-medium" style="width:163px" /> <span
						...
						<li><label>手机：</label> <input type="text" id="phoneno" name="phoneno" maxlength="100" class="input-medium" style="width:163px"
							value="${users.phoneno}" readonly="readonly" onkeyup="keyupInput(this);" /> <!-- 	<span class="help-inline"><font color="red">*</font> </span> -->
						</li>
						<li class="clearfix"></li>
						
						<li><label style="margin-left: 24px">身份证号：</label> <input type="text" id="cardno" name="cardno" maxlength="100" class="input-medium" style="width:163px"
						...
						<li><label>支付积分：</label> <input type="text" id="currentPoint" name="currentPoint" maxlength="10" class="input-medium"
							onkeyup="keyupInput(this);" readonly="readonly" value="${users.currentPoint}" /></li>
						...
						<li><label style="margin-right: 400px;margin-top: 35px;">头像：</label>
							<div style="border:1px solid #eee;width:120px;height:120px;cursor: pointer;margin-left: 140px;margin-top: -50px;">
								<img id="headImg" style="width:120px;height:120px;cursor: pointer;"
									src="${users.headImg}" /> <input class="btn btn-primary"
					...
					<input id="upImage1" type="file" name="cardFaceImg_file" style="display:none" /> <input id="upImage2" type="file" name="cardOtherImg_file"
						style="display:none" />
					<!-- 驾驶证图片 -->
					<input id="upImage3" type="file" name="driveLicenceImg1_file" style="display:none" /> <input id="upImage4" type="file" name="driveLicenceImg2_file"
						style="display:none" />
					<!-- 行驶证图片 -->
					<input id="upImage5" type="file" name="moveLicenceImg1_file" style="display:none" /> <input id="upImage6" type="file" name="moveLicenceImg2_file"
						style="display:none" />
				...
				<div role="tabpanel" class="tab-pane" id="profile">
					<div style="overflow:-Scroll;overflow-y:hidden;height: 800px;">
						<ul class="ul-form" style="height:750px;">
							<li ><label>车牌号：</label> <input type="text" id="truckNo"
								name="truckNo" maxlength="100" class="input-medium" style="width:163px" value="${drivers.truckNo}" /> <span class="help-inline"><font
									color="red">*</font> </span></li>
							<li ><label>车型：</label> <select id="truckType" name="truckType"
								class="input-medium" style="width: 177px;">
									<option value="">不限</option>
							...
							<li class="clearfix" ></li>
							<li ><label >车长：</label> <select id="truckLength" name="truckLength"
								class="input-medium" style="width: 177px;">
									<c:forEach items="${truckLength}" var="t">
										<option value="${t.value}" <c:if test="${t.value==drivers.truckLength}">selected</c:if>>${t.label}</option>
									</c:forEach>
							</select></li>
							<li ><label style="margin-left:24px;">车宽：</label> <select id="truckWidth" name="truckWidth"
								class="input-medium" style="width: 177px;">
		   		...
		   		<select id="truckMaxwight" name="truckMaxwight"  class="input-medium"  style="width: 177px;">
		   			...
		   			<option value="${t.value}" <c:if test="${t.value==drivers.truckMaxwight}">selected</c:if>>${t.label}</option>
							...
							<li ><label style="margin-top: 10px;">承重：</label> <input type="text" id="truckMaxwight"
								name="truckMaxwight" maxlength="50" class="input-medium" onkeyup="keyupInput1(this);" style="width:163px" value="${drivers.truckMaxwight}" />&nbsp;&nbsp;吨
							</li>

							<!-- 添加身份证图片 -->
							<li id="imagesCradNo" >
								<label style="text-align:left;width:100%;padding-left:50px">身份证照片：</label>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 85px;margin-top: -1px;">
									<img id="cardFaceImg" style="width:120px;height:120px;cursor: pointer;" src="${users.cardFaceImg}" />
								...
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 215px;margin-top: -122px;">
									<img id="cardOtherImg" style="width:120px;height:120px;cursor: pointer;" src="${users.cardOtherImg}" />
									<div style="width: 124px;height: 43px;margin-top: -130px;">
							...
							<li id="imagesDriveLicence" style="margin-top: 155px;">
								<label style="text-align:left;width:100%;padding-left:50px">驾驶证：</label>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 85px;margin-top: -1px;">
									<img id="driveLicenceImg1" style="width:120px;height:120px;cursor: pointer;" src="${drivers.driveLicenceImg1}" />
									<div style="width: 124px;height: 43px;margin-top: -130px;">
										<input class="btn btn-primary" type="button" style="margin-left: 0px;margin-top: 138px;" value="驾驶证正面" onclick="addImg3();" />
									</div>
								</div>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 215px;margin-top: -122px;">
									<img id="driveLicenceImg2" style="width:120px;height:120px;cursor: pointer;" src="${drivers.driveLicenceImg2}" />
									<div style="width: 124px;height: 43px;margin-top: -130px;">
							...
							<li id="imagesDriverCard" style="margin-top: 155px;">
								<label style="text-align:left;width:100%;padding-left:50px">行驶证：</label>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 85px;margin-top: -1px;">
									<img id="moveLicenceImg1" style="width:120px;height:120px;cursor: pointer;"
										src="${drivers.moveLicenceImg1}"/>
									<div style="width: 124px;height: 43px;margin-top: -130px;">
										<input class="btn btn-primary" type="button" style="margin-left: 0px;margin-top: 138px;" value="行驶证正面" onclick="addImg5();" />
									</div>
								</div>
								<div style="border:1px solid #eee;width:120px;height:120px;margin-left: 215px;margin-top: -122px;">
									<img id="moveLicenceImg2" style="width:120px;height:120px;cursor: pointer;"
										src="${drivers.moveLicenceImg2}"/>
									<div style="width: 124px;height: 43px;margin-top: -130px;">
