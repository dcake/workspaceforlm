...
<head>
	...
	<script type="text/javascript">
		...
		function exitLogin(){
			layer.confirm("确认要退出吗？", {icon: 3, title:'提示', shade: 0}, function(index){
	...
	<div id="main">
		<div id="header" class="navbar navbar-fixed-top">
			<div class="navbar-inner">
				<div class="brand"style="padding:0px 10px 0px 25px;"><span id="productName"><img alt="九州网" src="${ctxStatic}/images/indexLogo.png" style="width:156px;height:45px;"></span></div>
 				<%-- <div class="brand"><span id="productName">${fns:getConfig('productName')}</span></div> --%>
				<ul id="userControl" class="nav pull-right">
					<li><a href="javascript:location.reload();" target="_blank" title="访问网站主页"><i class="icon-home"></i></a></li>
	...
	<script type="text/javascript"> 
		...
		function wSizeWidth(){
			if (!$("#openClose").is(":hidden")){
				...
				var table1 = document.getElementById('mainFrame').contentWindow.document.getElementById('contentTable');
				var table2 = document.getElementById('mainFrame').contentWindow.document.getElementById('contentBody');
				$(table2).animate({width:$(table1).width()+2.5+"px"});
			}else{
				$("#right").width("100%");
			}
