			...
			<div class="tab-content">
				<div role="tabpanel" class="tab-pane active" id="home">
					...
					<ul class="ul-form" style="height:350px;">
						<li><label>昵称：</label> <input type="text" id="username" name="username" maxlength="50" class="input-medium" style="width:163px"
						...
						<li><label>密码：</label> <input type="password" id="password" name="password" placeholder="若不修改密码，请留空" maxlength="50" class="input-medium" style="width:163px" /> <span
						...
						<li><label>手机：</label> <input type="text" id="phoneno" name="phoneno" maxlength="20" class="input-medium" style="width:163px"
							onkeyup="keyupInput(this);" readonly="readonly" value="${users.phoneno}" /> <!--  	<span class="help-inline"><font color="red">*</font> </span> -->
						</li>
						
						<li><label style="margin-left: 24px">身份证号：</label> <input type="text" id="cardno" name="cardno" maxlength="50" class="input-medium" style="width:163px"
					...
					<input id="upImage1" type="file" name="cardFaceImg_file" style="display:none" /> <input id="upImage2" type="file" name="cardOtherImg_file"
						style="display:none" />
					<!-- 营业执照 -->
					<input id="upImage3" type="file" name="businessLicenseFaceImg_file" style="display:none" /> <input id="upImage4" type="file"
						name="businessLicenseOtherImg_file" style="display:none" />
				</div>
				<!-- --------------------------------------------------------认证信息----------------------------------------- -->
					...
					<div style="overflow:-Scroll;overflow-y:hidden;height:500px;">
						<ul class="ul-form" style="height:600px;">
							<li><label>企业名称：</label> <input type="text" id="companyName" name="companyName" maxlength="50" class="input-medium" style="width:163px"
								value="${agents.companyName}" /> <span class="help-inline"><font color="red">*</font> </span></li>
							<!-- 添加身份证图片 -->
							<li class="clearfix"></li>
