...
<body>
	<form:form id="searchForm" modelAttribute="hotEvent" action="${ctx}/agents/agents/list" method="post" class="breadcrumb form-search">
		...
		<ul class="ul-form">
			<li><label width="90px;">姓名：</label> <input id="truename" name="truename" type="text" maxlength="50" style="height:20px;"
				class="input-medium input-short" value="${agents.truename}" /></li>
			<li><label width="90px;">手机号：</label> <input id="phoneno" name="phoneno" type="text" maxlength="20" style="height:20px;"
