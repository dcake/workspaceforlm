...
public class AlipayNotify {
    ...
    public static boolean verify(Map<String, String> params) throws UnsupportedEncodingException {
        ...
        //responsetTxt的结果不是true，与服务器设置问题、合作身份者ID、notify_id一分钟失效有关(也有可能与编码格式有关)
        //isSign不是true，与安全校验码、请求时的参数格式（如：带自定义参数等）、编码格式有关
    	String responseTxt = "false";
		if(params.get("notify_id") != null) {
//			String notify_id = new String(params.get("notify_id").getBytes("ISO-8859-1"),"UTF-8");
			String notify_id = new String(params.get("notify_id"));
