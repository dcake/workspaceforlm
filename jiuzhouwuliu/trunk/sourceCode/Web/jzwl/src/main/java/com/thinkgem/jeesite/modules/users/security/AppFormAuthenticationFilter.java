 ...
 */
@Service
public class AppFormAuthenticationFilter extends org.apache.shiro.web.filter.authc.FormAuthenticationFilter {

	public static final String DEFAULT_CAPTCHA_PARAM = "validateCode";
	public static final String DEFAULT_MESSAGE_PARAM = "message";
	public static final String DEFAULT_USERSORT_PARAM = "userSort";
	private String captchaParam = DEFAULT_CAPTCHA_PARAM;
	private String messageParam = DEFAULT_MESSAGE_PARAM;
	private String userSort = DEFAULT_USERSORT_PARAM;	//用户分类
	
	protected AuthenticationToken createToken(ServletRequest request, ServletResponse response) {
		String username = getUsername(request);
		String password = getPassword(request);
		String userSort = getUserSort(request);
		if (password==null){
			password = "";
		}
		...
		return new AppUsernamePasswordToken(username, password.toCharArray(), rememberMe, host, captcha,userSort);
	}
	...
	protected String getUserSort(ServletRequest request) {
		return WebUtils.getCleanParam(request, getUserSort());
	}
