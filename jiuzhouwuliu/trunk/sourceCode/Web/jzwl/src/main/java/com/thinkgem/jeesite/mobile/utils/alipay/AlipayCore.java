...
public class AlipayCore {
	 ...
	 * 
	 */
	public static String getOrderInfo(String subject, String body,BigDecimal amountPayable,String out_trade_no) {
		// 合作者身份ID
		...
		orderInfo += "&body=" + "\"" + body + "\"";
		// 商品金额
		//orderInfo += "&total_fee=" + "\"" + amountPayable.divide(new BigDecimal(1), 2,BigDecimal.ROUND_HALF_UP) + "\"";
		orderInfo += "&total_fee=" + "\"" + amountPayable + "\"";
		// 服务器异步通知页面路径
		//orderInfo += "&notify_url=" + "\""+ "http://192.168.2.12:8080/" + "\"";
		orderInfo += "&notify_url=" + "\""+ "http://114.215.92.62:8088/mobileBid/aliPayReturn" + "\"";
		// 接口名称， 固定值
